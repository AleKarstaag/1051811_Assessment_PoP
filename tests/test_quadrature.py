...
@pytest.mark.parametrize("dataframe_file_name, function, vertex_1, vertex_2, vertex_3,ans", [
...
def test_triangle_quadrature_rule(dataframe_file_name,function, vertex_1,vertex_2,vertex_3,ans):
    """Test """
    dataframe=pd.read_csv(f"data/{dataframe_file_name}.csv")
    from basis import ZhangCuiLiu_triangle_quadrature_rule
    I=ZhangCuiLiu_triangle_quadrature_rule(dataframe,function,vertex_1,vertex_2,vertex_3)
